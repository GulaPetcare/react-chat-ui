import React__default, { createElement, useRef, useEffect } from 'react';
...
var BubbleGroupHeader = styled.h5(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  margin: 0;\n  margin-bottom: 4px;\n  font-size: 14px;\n  font-weight: 500;\n  color: ", ";\n  font-family: ", ";\n"], ["\n  margin: 0;\n  margin-bottom: 4px;\n  font-size: 14px;\n  font-weight: 500;\n  color: ",
    ";\n  font-family: ", ";\n"])), function (props) {
    return props.me
        ? props.theme.bubbles.mineHeader
        : props.theme.bubbles.theirHeader;
}, function (props) { return props.theme.fontFamily; });
var ChatBubbleWrapper = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  overflow: auto;\n  max-width: 420px;\n  margin-left: ", ";\n"], ["\n  overflow: auto;\n  max-width: 420px;\n  margin-left: ", ";\n"])), function (props) { return props.me && "auto"; });
var handleBorderRadius = function (me, first) {
    var bubbleRadius = "2px 8px 8px 0";
    if (me) {
...
var ChatBubbleUI = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: ", ";\n  margin: 1px auto;\n  padding: 12px 16px;\n  min-width: fit-content;\n  float: ", ";\n"], ["\n  background-color: ",
    ";\n  border-radius: ", ";\n  margin: 1px auto;\n  padding: 12px 16px;\n  min-width: fit-content;\n  float: ", ";\n"])), function (props) {
    return props.me
...
}, function (props) { return props.theme.bubbles.messageFontSize; }, function (props) { return props.theme.bubbles.messageFontFamily; }, function (props) {
    return props.me ? props.theme.bubbles.mineColor : "#0000EE";
});
function ChatBubble(props) {
    var isFirstMessage = props.first != null ? props.first : true;
    return (createElement(ChatBubbleWrapper, { me: props.message.fromMe },
        createElement(ChatBubbleUI, { "data-test-id": "rcu-bubble", me: props.message.fromMe, first: isFirstMessage },
            props.showSenderName && props.senderName !== "You" && (createElement(BubbleGroupHeader, { me: props.message.fromMe }, props.senderName)),
            createElement(react, null,
...
var ChatInput = function (props) {
    ...
    return (createElement("div", { className: "chat-input", style: styles.chatInput },
        createElement("input", { type: "text", style: inputStyles || styles.inputStyle, placeholder: inputPlaceholder })));
};
...
var ChatHistory = styled.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  padding: 0 10px;\n  overflow: auto;\n  height: ", ";\n  max-height: ", ";\n"], ["\n  padding: 0 10px;\n  overflow: auto;\n  height: ",
    ";\n  max-height: ",
    ";\n"])), function (props) {
...
function ChatFeed(_a) {
    ...
    var messageNodes = messages.map(function (message, index) {
        ...
        if (index === messages.length - 1 ||
            ...
            group = [];
            return (createElement(BubbleGroup, { key: index, messages: messageGroup, id: message.senderId, showSenderName: showSenderName, chatBubble: ChatBubble$1 }));
        }
        return null;
    });
    // Other end is typing...
    if (isTyping) {
        messageNodes.push(createElement(TypingIndicator, { key: "is-typing" },
            createElement(ChatBubble$1, { message: new Message({
                    fromMe: false,
                    senderId: "1",
                    message: "...",
                    senderName: "",
    ...
    return (createElement(ThemeProvider, { theme: mergeParentTheme },
        createElement(ChatPanel, null,
            createElement(ChatHistory, { ref: chat, maxHeight: maxHeight },
